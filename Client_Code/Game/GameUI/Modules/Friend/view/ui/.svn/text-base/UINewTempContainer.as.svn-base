package GameUI.Modules.Friend.view.ui
{
	...
	public class UINewTempContainer extends Sprite
	{
		...
		protected function onCellClickHandler(e:MouseEvent):void{
			...
			if(this.menu.roleInfo.idTeam==0){
			...
			if(this.menu.roleInfo.idTeam>0 && GameCommonData.Player.Role.idTeam==0){
...
//			dataList.push({cellText:GameCommonData.wordDic[ "mod_fri_view_med_friendA_han_11" ],data:{hasChild:false,type:GameCommonData.wordDic[ "mod_fri_view_med_friendA_han_11" ]}});//"加为好友"		"加为好友"
