package GameUI.Modules.UnityNew.View
{
	...
	public class SingleMemberListCell extends Sprite implements IUnityCell
	{
		...
		public function init():void
		{
			...
			main_mc = NewUnityResouce.getMovieClipByName("MemberLabel");
			...
			( main_mc[ "txt_3" ] as TextField ).htmlText = unityVo.totalContribute.toString();;//unityVo.sexStr;
			( main_mc[ "txt_4" ] as TextField ).htmlText = unityVo.fighting.toString();;//unityVo.mainJobStr;
