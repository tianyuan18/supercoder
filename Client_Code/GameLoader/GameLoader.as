...
//			GameLoaderData.outsideDataObj.fcmConfig = this.loaderInfo.parameters["fcmConfig"];				//单个用户防沉迷开关 0 没通过，要弹窗  1 已经通过，不弹  
			...
			GameLoaderData.outsideDataObj.userName = "lr002";//this.loaderInfo.parameters["username"];															// 账号
			GameLoaderData.outsideDataObj.password = "111111";// this.loaderInfo.parameters["4399uid"];															// 密码
			GameLoaderData.outsideDataObj.serverid = "1";//this.loaderInfo.parameters["serverid"];															// 服务器编号s1,s2
			
			GameLoaderData.outsideDataObj.AccSocketIP      = "192.168.0.200";//this.loaderInfo.parameters["AccSocketIP"];												// 账号服务器地址
			GameLoaderData.outsideDataObj.AccSocketPort   =8846; //this.loaderInfo.parameters["AccSocketPort"];												// 账号服务器端口
			GameLoaderData.outsideDataObj.SourceURL       = "E:/Client_Code/";//this.loaderInfo.parameters["SourceURL"];													// 游戏服务器
			GameLoaderData.outsideDataObj.cztype          = this.loaderInfo.parameters["cztype"];													// 是否显示充值开关（0为关,1为开）
			GameLoaderData.outsideDataObj.preventWallowTime = this.loaderInfo.parameters["preventWallowTime"];				//防沉迷定时器
			GameLoaderData.outsideDataObj.showAccount = this.loaderInfo.parameters["showAccount"];				//防沉迷弹出次数
			GameLoaderData.outsideDataObj.fcmPower = this.loaderInfo.parameters["fcmPower"];				//平台防沉迷开关 1 开启  0 关闭  
			GameLoaderData.outsideDataObj.fcmConfig = this.loaderInfo.parameters["fcmConfig"];
...
//			\th
		...
		private function testLoader():void
		{
			...
			GameLoaderData.outsideDataObj.userName = "zy068";
			GameLoaderData.outsideDataObj.password = "111111";   
