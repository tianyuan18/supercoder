package Net.ActionSend
{
	...
	public class CreateRoleSendInl
	{
...
//		USHORT	unData;	//职业 + 性别
			...
			m_TempByteArr.writeMultiByte(parm.shift(),GameLoaderData.wordCode);	                                  //名字				
			...
			m_TempByteArr = new ByteArray( );
			m_TempByteArr.writeMultiByte(parm.shift(),GameLoaderData.wordCode);					                  //保护密码
			m_byteArr.writeBytes(m_TempByteArr,0,m_TempByteArr.length);
			...
			GameLoaderData.outsideDataObj.GameNets.Send(m_byteArr);
		}
	}
}